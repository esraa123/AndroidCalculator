...
public class dd extends Application 
{
 ...
 public void start(Stage primaryStage)
 {
	 ...
	 Button signal=new Button("+/-");
	 signal.setPrefSize(70,60);
	 signal.setStyle("-fx-base: #fe847f;");

	 h1.setSpacing(1);
	 h1.setAlignment(Pos.CENTER);
	 h1.getChildren().addAll(b7,b8,b9,sum,sub,signal,square,sin);
	...
	//---------------------------------------------------- Opeartion ----------------------------------//
		...
		signal.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				
				{
		            ...
		            operator = "+/-";
		            number1=-1*Double.parseDouble(tf.getText());
		            val=number1;
	            	 tf.setText("");
